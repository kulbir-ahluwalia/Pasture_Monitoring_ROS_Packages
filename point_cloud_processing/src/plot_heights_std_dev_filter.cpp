...
int main(int argc, char** argv)
{
    ...
    */
    ...
    std::string plot_plant_three_std_height_csv_file_path = path + "plot_plant_three_std_heights.csv";
    ...
    // initiate height file for plot points greater than (mean +three std)
    std::ofstream height_file_plot_plants_four_std;
    height_file_plot_plants_four_std.open(plot_plant_three_std_height_csv_file_path);
